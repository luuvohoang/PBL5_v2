...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\GIGABYTE\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.410\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20eaa146249bcdaca85046UE9YCRoGCFVcVAVSAlMHDwZUAlcG', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/GIGABYTE/.vscode/extensions/wallabyjs.console-ninja-1.0.410/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20eaa146249bcdaca85046UE9YCRoGCFVcVAVSAlMHDwZUAlcG', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

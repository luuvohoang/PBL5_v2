...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\GIGABYTE\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.410\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20efcf8f07d822464fa6b1UEhaXhZWCgBXDwcHUgFSUlVSVgcH', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/GIGABYTE/.vscode/extensions/wallabyjs.console-ninja-1.0.410/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20efcf8f07d822464fa6b1UEhaXhZWCgBXDwcHUgFSUlVSVgcH', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
